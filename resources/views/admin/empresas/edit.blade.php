    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('admin.empresas.update', $empresa) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <a href="{{ route('admin.empresas.show', $empresa) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
